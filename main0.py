...
data = "1111111111111111111111111222222222222222222222222222222222222233333333"
env.process(node0.start(data=data,start_time=0.4,file_id=0,des_node=node1,nodes=nodes))
env.process(node2.start(data=data,start_time=0,file_id=1,des_node=node3,nodes=nodes))
env.process(node0.start(data=data,start_time=0.2,file_id=2,des_node=node3,nodes=nodes))
env.run(until=50)
